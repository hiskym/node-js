    ...
    .values([
      {
        ...
        description:
          "Competition kettlebell s jednotnou velikostí těla, vhodný pro technický i silový trénink.",
        price: "1290.00",
        currency: "CZK",
        isFeatured: true,
        createdAt: now(),
      ...
      },
      {
        ...
        description:
          "Sada odporových gum pro posílení celého těla, rehabilitaci i mobilitu.",
        price: "499.00",
        currency: "CZK",
        isFeatured: true,
        createdAt: now(),
      ...
      },
      {
        ...
        description:
          "Masážní válec pomáhá s regenerací, uvolněním svalů a zlepšením mobility.",
        price: "399.00",
        currency: "CZK",
        isFeatured: false,
        createdAt: now(),
